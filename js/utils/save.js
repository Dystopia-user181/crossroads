...
function fixData(defaultData, newData) {
	...
	for (r in player.plHome.grid) {
		for (t in player.plHome.grid[r]) {
			if (player.plHome.grid[r][t].constructor == Array) player.plHome.grid[r][t][1] = new Decimal(player.plHome.grid[r][t][1])
		}
	}
	for (r in player.plHome.fgrid) {
		for (t in player.plHome.fgrid[r]) {
			if (player.plHome.fgrid[r][t]) {
				for (i in player.plHome.fgrid[r][t][1][1]) {
					player.plHome.fgrid[r][t][1][1][i] = new Decimal(player.plHome.fgrid[r][t][1][1][i]);
				}
			}
		}
	} 
...
function load() {
	...
	plHGrid = new Grid(player.plHome.grid, player.plHome.selected);
	plHFGrid = new Grid(player.plHome.fgrid, player.plHome.fselected);
